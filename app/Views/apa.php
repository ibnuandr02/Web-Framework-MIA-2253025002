...
<head>
    ...
    <title>apa - KampusXplore Lampung</title>
</head>
            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    ...
                    <section class="section" id="featured">
                        <div class="detail">
                            <img src="./img/Logo website KXL.png" class="img-fluid" alt="...">
                            ...
                            <div class="article mt-3">
                                <h1>Apa yang Bisa Anda Temukan di Website Ini?</h1>
                                <p class="mt-3">Profil Kampus – Informasi lengkap tentang universitas dan perguruan tinggi di Lampung, baik negeri maupun swasta.
