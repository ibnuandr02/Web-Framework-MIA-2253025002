            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    ...
                    <section class="section" id="featured">
                        <div class="detail">
                            <img src="./img/Mahasiswa.png" class="img-fluid" alt="...">
                            <div class="post-cat mt-5">
                                ...
                                <div class="meta mt-3 ">
                                    ...
                                    <span>Senin, 10 Maret 2025</span>
                                </div>
                            </div>
                            <div class="article mt-3">
                                <h1>Mengapa memilih kuliah di Lampung</h1>
                                <p class="mt-3">Lampung adalah pilihan tepat untuk melanjutkan pendidikan tinggi karena memiliki berbagai universitas dan perguruan tinggi berkualitas dengan beragam program studi unggulan. 
                                    Biaya kuliah dan biaya hidup di Lampung relatif lebih terjangkau dibandingkan kota besar lainnya, menjadikannya pilihan ekonomis tanpa mengorbankan kualitas pendidikan.</p>
                                <p>Selain itu, lokasi yang strategis dengan akses transportasi yang mudah, lingkungan yang nyaman dan kondusif untuk belajar, 
                                ...
                                <figcaption class="blockquote-footer mt-5">
                                    <span>#Tags: </span>
                                    <cite title="Source Title">KampusXplore, Lampung, Universitas</cite>
                                </figcaption>
                        ...
                        <div class="comment mt-5 p-5">
                            ...
                            <form class="mt-4" action="" method="post">
                                ...
                                <div class="mt-3 mb-3">
                                    <textarea class="form-control" placeholder="Komentar"
                                        id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
                                <button type="submit" class="btn">Unggah Komentar</button>
                            </form>
                        </div>
