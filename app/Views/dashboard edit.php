    ...
    <div class="form-container">
      <form>
        <div class="form-group">
          <label for="blog-id">ID Blog</label>
          <input type="text" id="blog-id" value="1" readonly>
        </div>
        
        <div class="form-group">
          <label for="blog-title">Nama Blog</label>
          <input type="text" id="blog-title" value="Isi disini">
        </div>
        
        <div class="form-group">
          <label for="blog-author">Slug</label>
          <input type="text" id="blog-author" value="Isi disini">
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="blog-content">Isi disini</textarea>
        </div>
