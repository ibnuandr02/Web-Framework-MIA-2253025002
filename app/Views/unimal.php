...
<head>
    ...
    <title>Universitas Malahayati - KampusXplore Lampung</title>
</head>
            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    ...
                    <section class="section" id="featured">
                        <div class="detail">
                            <img src="./img/UNIMAL.jpg" class="img-fluid" alt="...">
                            <div class="post-cat mt-5">
                                <a href="#" class="btn">Tentang</a>
                                <a href="#" class="btn">Universitas Malahayati</a>
                                <div class="meta mt-3 ">
